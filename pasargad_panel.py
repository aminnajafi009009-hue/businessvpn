...
async def _request(panel: dict, method: str, path: str, json_body: dict | None = None, params: dict | None = None):
    ...
    if status == 401:
        ...
        return False, data, "توکن نامعتبر/منقضی بود (401). لطفاً دوباره تلاش کنیح."
    if status == 404:
